    ...
    <div class="newsongs-title">
      <el-menu
        ...
        :active-color="getActiveColor" 
          mode="horizontal"
      >
      <el-menu-item v-for="(item,index) in areas" :key='index' :index='index'  @click="handleAreasClick">{{item.content}}</el-menu-item>
      </el-menu>
      <split />
...
import { _getSongsDetail, songDetail } from "api/detail";
